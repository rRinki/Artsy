    ...
    font family:}
      ...
      <form:form action="addcustomer" method = "POST" modelAttribute="customerobject">
         ...
         <div class="form-group col-md-12">
            <form:input type="text" class="form-control" placeholder="First Name" path="cus_Name"/>
        </div>

        <div class="form-group col-md-12">
            <form:input type="text" class="form-control" placeholder="Last Name" path="cus_Name"/>
        </div>

        <div class="form-group col-md-12">
            <form:input type="text" class="form-control" placeholder="Enter Email" path="cus_Email"/>
        </div>
