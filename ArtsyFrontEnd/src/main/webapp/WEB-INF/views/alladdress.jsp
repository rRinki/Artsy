...
<body>
	<div class="container">
		...
		<c:if test="${empty addresslist}">
			<div class="jumbotron">
			<h4>Please Add Address To Continue </h4></div>
		</c:if>
							...
							<div class="card-body">
								...
								<div class="row" style="margin-top: 2%">
									...
									<div class="col-9" style="margin-top:3%";>
										<a href="" class="btn btn-danger navbar-btn"> <i class="fa fa-truck"></i>
											Place Order
										</a>
									</div>
									</div>
						...
						<form action="addaddress" method="post">
							...
							<div class="form-group col-md-12">
								<label>Customer Name</label> <input type="text"
									class="form-control" placeholder="Name**" name="name" id="name" required="required" />
							</div>

							<div class="form-group col-md-12">
								<label>Address Line1</label> <input type="text"
									class="form-control" placeholder="Line1**" name="line1"  id="line1" required="required"/>

							</div>

							<div class="form-group col-md-12">
								<label>Address Line2</label> <input type="text"
									class="form-control" placeholder="Line2**" name="line2" id="line2" required="required"/>
							...
							<div class="form-group col-md-12">
								<label>Pincode</label> <input type="text" class="form-control"
									placeholder="Pincode**" name="pincode"  id="pincode" required="required"/>
							</div>
							<a href=""></a>
	...
	<c:if test="${edit}">
		<div class="container">
			<form action="updateaddress" method="post">
				...
				<div class="form-group col-md-12">
					<label>Area</label> <input type="text" class="form-control"
						placeholder="Area**" name="area" id="area"  required="required" value="${addressobject.area}" />

				</div>
				<div class="form-group col-md-12">
					<label>Pincode</label> <input type="text" class="form-control"
						placeholder="Pincode**" name="pincode" id="pincode" required="required" value="${addressobject.pincode}" />
